...
| 9 | `Photos` | Write-once evidence, reviewer decision, advisory AI fields | Supervisor, reviewer | 71 | 120 | Yes | Yes — **the volume driver** | No | SiteVisits, VisitActivities |
...
- **412 fields across 17 tables.** The reference architecture holds 864 fields across 46 tables; the rest is designed and deferred.
