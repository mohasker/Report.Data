...
| WhatsApp as an **output** channel | **In scope by native share (D-16)** | One share action hands the stored files to the operating system's share sheet. Not automation, not scraping, no public link. Unverified: `CAP-GATE` |
