...
| [0009](ADR-0009-capture-once-native-share.md) | Capture once, use twice, and share through the native share sheet | Accepted (**D-16 to D-21**) — one capture serves the contractor group and every report; the written description becomes optional; `CAP-GATE` is the unverified platform requirement |
